...
(function ($) {
    ...
    Node = (function () {
        ...
        Node.prototype.render = function () {
            ...
            let padding = this.level() * settings.indent;
            this.indenter[0].style.paddingLeft = "" + padding + "px";
            this.row[0].querySelector(".comment-actions").style.paddingLeft = "" + padding + "px";
